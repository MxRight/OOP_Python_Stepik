...
также при уменьшении поля во избежании зависания при поиске места для расстановки нового корабля при переборе n-нного количества операций расстановка новых кораблей прекращается"""
